<?php
$page_title = "Tranquil Minds Mental Health - Biological Neural Flow";
$page_description = "Tranquil Minds Mental Health: Experience the flow of biological neural networks";
?>
